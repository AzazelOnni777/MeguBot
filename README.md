...
Originally a Marie fork, megu evolved further and was built to be more robust and more dedicated to Anime Chats. 

Can be found on telegram as [MeguBot](https://t.me/MeguABR_Bot).

The Support group can be reached out to at [Megu Support](https://t.me/MeguSupport), where you can ask for help about @MeguABR_Bot, discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
...
### Read these notes carefully before proceeding 
 ...
 - Your code must be open source and a link to your fork's repository must be there in the start reply of the bot. [See this](https://github.com/NachABR/MeguBot/blob/shiken/MeguBot/__main__.py#L25)
...
Note: This instruction set is just a copy-paste from Marie, note that [One Punch Support](https://t.me/OnePunchSupport) aims to handle support for @MeguBot and not how to set up your own fork. If you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to set up the bot instance in the support chat, it aims to help our own instance of the bot and not the forks.
...
This file should be placed in your `MeguBot` folder, alongside the `__main__.py` file. 
